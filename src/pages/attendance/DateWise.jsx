...
const DataWise = () => {
  ...
  // aigula sob antd desing e kaj .

  console.log('currentDate', currentDate.toString());

  return (
    // but ai page ami korchi . oi component gula call korchi
    <>
      <EmpList>
            ...
            <div>
              <Space direction="vertical" size={12}>
                {/* <RangePicker
                  ...
                  disabled={[false]}
                /> */}
                <DatePicker className="h-11 mt-1 ml-2" defaultValue={dayjs(currentDate.toString(), 'DD/MM/YYYY')} format={'DD/MM/YYYY'} />
              </Space>
            </div>
                      ...
                      <table class="min-w-full border text-center">
                        ...
                        <tbody>
                          <tr class="border-b">
                            ...
                            <td class="text-sm text-red-600 font-medium px-6 py-4  border-r">35</td>
